        ...
        this.selectData("", "question", "*").then((getIDQuestion) => {
            ...
            this.selectData("", "theme", "*").then((getIDTheme) => {
                ...
                this.db.executeSql("INSERT INTO `explication` (`titre`, `image`, `texte`, `titreBouton`, `texteBouton`, `idQuestion`, `idTheme`) VALUES ('Le marché du travail est très ouvert pour les informaticiens. Le monde numérique évolue toujours plus et il y a beaucoup plus d offres que de demandes.', 'image', '', 'bouton', 'En savoir plus', " + getIDQuestion[question++].id + ", 0)", [])
                    .catch(e => console.log(e));
                this.db.executeSql("INSERT INTO `explication` (`titre`, `image`, `texte`, `titreBouton`, `texteBouton`, `idQuestion`, `idTheme`) VALUES ('240 000 000€ !\nC est le prix de l ordinateur le plus cher du monde, disponible pour les entreprises et les professionelles. Ce type d ordinateur permet généralement de faire des milliards de milliard de calculs par secondes.', 'image', '', 'bouton', 'En savoir plus', " + getIDQuestion[question++].id + ", 0)", [])
                    .catch(e => console.log(e));
