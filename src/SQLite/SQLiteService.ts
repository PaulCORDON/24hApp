...
export class SQLiteService {
    ...
    insertInTable() {
        this.db.executeSql("INSERT INTO `theme` (`nom`, `progression`, `nbTicketActuel`, `nbTicketMax`) VALUES ('La place des femmes dans l''informatique', 0, 0, 1), ('Le code / La programmation', 0, 0, 1), ('Trouvez des geeks', 0, 0, 1), ('Culture informatique', 0, 0, 1)", [])
        ...
        this.selectData("", "question", "*").then((getIDQuestion) => {
            ...
            this.selectData("", "theme", "*").then((getIDTheme) => {
                ...
                this.db.executeSql("INSERT INTO `explication` (`titre`, `image`, `texte`, `titreBouton`, `texteBouton`, `idQuestion`, `idTheme`) VALUES ('Un informaticien est une personne normale. Nous pouvons voir dans certaines séries ou certains films des stéréotypes d''informaticiens tels que les lunettes rondes, des boutons, un gamer hardcore, des cheveux longs, des personnes asociables.\nVenez nous rencontrer, nous casserons tous vos préjugés.', 'image', '', 'bouton', 'En savoir plus', " + getIDQuestion[question++].id + ", 0)", [])
                    .catch(e => console.log(e));
                this.db.executeSql("INSERT INTO `explication` (`titre`, `image`, `texte`, `titreBouton`, `texteBouton`, `idQuestion`, `idTheme`) VALUES ('Le travail d''informaticien est avant tout un travail d''équipe. Pour développer une application quelconque, il faut plusieurs compétences qui sont toutes complémentaires et qu''on retrouve chez chaque informaticien spécialisé : un lead programmer, un designer UX, un Data Analyst, un graphiste, ect', 'image', '', 'bouton', 'En savoir plus', " + getIDQuestion[question++].id + ", 0)", [])
                    .catch(e => console.log(e));
